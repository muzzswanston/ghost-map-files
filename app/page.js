...
export default function GhostMapFiles() {
  ...
  const [locationsNearLeyLines, setLocationsNearLeyLines] = useState(new Map());
  ...
  // ========== LEY LINES WITH ENHANCED GEOMETRY ==========
  const leyLines = [
  ...
  const getPerpendicularDistance = (lat, lng, lineStart, lineEnd) => {
  ...
  const getAssociatedLeyLines = (lat, lng) => {
  ...
  const addMarker = (location) => {
    ...
    const markerData = { marker, location, baseColor };
              ...
              <div className="space-y-8">
                ...
                <section className="bg-gradient-to-br from-slate-800 to-slate-900 border border-red-900/30 rounded-lg p-8 stagger-child">
                  ...
                  <p className="text-gray-300 text-sm">
                    <strong>What happens:</strong> When ley lines are activated, locations aligned with energy lines automatically detect their nearest line and glow with that line's unique color. Tap markers to see exact distances and energy associations.
                  </p>
                </section>

                <section className="bg-gradient-to-br from-slate-800 to-slate-900 border border-red-900/30 rounded-lg p-8 stagger-child">
                  <h2 className="accent-font text-2xl text-red-400 mb-4">Advanced Features</h2>
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex gap-3">
                      <span className="text-red-400">→</span>
                      <span><strong>Haversine Distance Calculation:</strong> Precise great-circle distance between Earth points</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-400">→</span>
                      <span><strong>Perpendicular Distance:</strong> Find shortest distance from location to ley line segment</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-400">→</span>
                      <span><strong>Dynamic Color Mapping:</strong> Markers glow with the color of nearest ley line</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-400">→</span>
                      <span><strong>Interactive Map:</strong> 45+ locations with instant ley line associations</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-400">→</span>
                      <span><strong>GPS Location Services:</strong> Find paranormal activity near you</span>
                    </li>
                  </ul>
                </section>
                ...
                <section className="bg-gradient-to-br from-slate-800 to-slate-900 border border-red-900/30 rounded-lg p-8 stagger-child">
                  ...
                  <ul className="space-y-2 text-gray-300 text-sm">
                    ...
                    <li>• <strong>Maps:</strong> Leaflet.js + OpenStreetMap (free, no API key needed)</li>
                    <li>• <strong>Geometry:</strong> Haversine formula, perpendicular distance, bearing calculations</li>
                    <li>• <strong>Hosting:</strong> Vercel (free tier recommended)</li>
                  </ul>
                </section>
              </div>
            </div>
